        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-sm">
              AI-powered trading assistant platform helping traders build, test, and deploy
              automated trading strategies with ease.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/sandbox" className="text-gray-600 hover:text-gray-900">
                  Sandbox Testing
                </Link>
              </li>
              <li>
                <Link to="/signals" className="text-gray-600 hover:text-gray-900">
                  Signal Filters
                </Link>
              </li>
            </ul>
